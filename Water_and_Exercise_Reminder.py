...
def doEyeExercise():
    PlaySound("Sounds/Alarm02.wav", SND_FILENAME | SND_LOOP | SND_ASYNC)
...
def drinkWater():
    PlaySound("Sounds/Alarm03.wav", SND_FILENAME | SND_LOOP | SND_ASYNC)
    plyer.notification.notify(
                        title = "Drink Water", 
...
def doPhysicalExercise():
    PlaySound("Sounds/Alarm04.wav", SND_FILENAME | SND_LOOP | SND_ASYNC)
    plyer.notification.notify(
